...
func (p *Parser) parseFnDecl() (*ast.FnDecl, error) {
    ...
    retTok, err := p.expect(token.TK_I32, "expected return type 'i32'")
    if err != nil {
        return nil, err
    }
...
func (p *Parser) parseParams() ([]ast.Param, error) {
    ...
    for {
        ...
        typeTok, err := p.expect(token.TK_I32, "expected parameter type 'i32'")
        if err != nil {
            return nil, err
        }
...
func (p *Parser) parseLet() (ast.Stmt, error) {
    ...
    if _, err := p.expect(token.TK_I32, "expected type 'i32'"); err != nil {
        return nil, err
    }
